...
public class MealDao extends AbstractDao<Meal, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Location = new Property(2, byte[].class, "location", false, "LOCATION");
    };
    ...
    public Meal readEntity(Cursor cursor, int offset) {
        Meal entity = new Meal( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getBlob(offset + 2) // location
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Meal entity, int offset) {
        ...
        entity.setLocation(cursor.isNull(offset + 2) ? null : cursor.getBlob(offset + 2));
     }
